...
\graphicspath{ {../scoutsbevaixch/static/} }
...
\fancyfoot[LO,LE]{Révision du 02/11/2022}
...
En plus de la somme versée pour la location une caution de 300.- sera demandée en express lors de la remise des clés.
...
\begin{itemize}
    \item[] \CheckBox[]{midi} +150 CHF : Location locaux de 11h à 17h (après-midi)
    \item[] \CheckBox[]{soir} +150 CHF : Location locaux de 17h à 11h (soir et matin)
    \item[] \CheckBox[]{dortoires} +50 CHF : avec dortoires
\end{itemize}

+ 300 CHF de caution, rendu à la fin de la location.

\textit{Pour toutes demandes particullière veuillez consulter le gérant.}

\subsection*{Signature}

\CheckBox[width=1em]{cbx} J'ai lu et compris le réglement de location (Section~\ref{sec:contract}).


Lieu et date \TextField[width=8cm]{date} 
